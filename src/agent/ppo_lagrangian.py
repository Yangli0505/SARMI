...
def ppo(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0,
    ...
    penalty_lr = 5e-2 # 5e-1 5e-2 增大无影响
...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed', type=int, default=3) # 1,2,3,4,5
    ...
    parser.add_argument('--cost_limit', type=float, default=0.1)  # 0.01  25
    parser.add_argument('--safe_check', type=bool, default=False) # False True
